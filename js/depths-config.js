...
var DUNGEON_MODIFIER_REGISTRY = {
  ...
  entropy: {
    id:              'entropy',
    name:            'Entropy',
    description:     'Every 8s a random placed block silently decays. Hazard blocks are immune. Infinite Depths Descent 3+ only.',
    effect:          'entropy',
    effectValue:     true,
    compatibleTiers: [DUNGEON_TIER_ABYSSAL],
    stackable:       false,
    exclusive:       [],
  },
};
...
var DUNGEON_FLOOR_TEMPLATES = {
  ...
  // ── Infinite Depths floor templates ────────────────────────────────────────
  // 7 floors per Descent. Difficulty scales from deep → abyssal within the
  // Descent; the Descent speed multiplier is applied on top in infinite-depths.js.
  infinite_1: {
    id:                   'infinite_1',
    floorNumber:          1,
    tier:                 DUNGEON_TIER_DEEP,
  ...
  infinite_2: {
    ...
    floorNumber:          2,
    tier:                 DUNGEON_TIER_DEEP,
    modifierPool:         ['narrow_corridor', 'fog_of_war', 'piece_drought', 'mirror_world'],
    modifierCount:        1,
    piecePaletteOverride: null,
    gravityMultiplier:    1.4,
    hazardBlockWeights:   { crumble: 3, magma: 2 },
    clearCondition:       { type: 'clear_lines', count: 18 },
    timeLimitSecs:        90,
  },
  infinite_3: {
    id:                   'infinite_3',
    floorNumber:          3,
    tier:                 DUNGEON_TIER_DEEP,
    modifierPool:         ['piece_drought', 'gravity_flux', 'obsidian_veins', 'mirror_world', 'entropy'],
    modifierCount:        2,
    piecePaletteOverride: null,
    gravityMultiplier:    1.5,
    hazardBlockWeights:   { crumble: 4, magma: 2 },
    clearCondition:       { type: 'mine_blocks', count: 25 },
    timeLimitSecs:        85,
  },
  infinite_4: {
    id:                   'infinite_4',
  ...
  infinite_5: {
    ...
    hazardBlockWeights:   { crumble: 4, magma: 4, void_block: 2 },
    clearCondition:       { type: 'mine_blocks', count: 35 },
    timeLimitSecs:        75,
  },
  infinite_6: {
    id:                   'infinite_6',
  ...
  infinite_boss: {
    ...
    clearCondition:       { type: 'survive_time', seconds: 120 },
    timeLimitSecs:        180,
  },
...
var DUNGEON_DEFINITIONS = {
  ...
  abyssal_rift: {
    ...
    bossSlot:         { floor: 4, bossId: 'the_wither_storm' },
  },

  // ── Infinite Depths ──────────────────────────────────────────────────────
  // Each Descent is a 7-floor run. Floor 7 = Wither Storm boss.
  // Unlocked after defeating the Wither Storm in the Abyssal Rift.
  infinite_descent: {
    id:               'infinite_descent',
    name:             'Infinite Depths',
    tier:             DUNGEON_TIER_ABYSSAL,
    floorCount:       7,
    floors:           ['infinite_1', 'infinite_2', 'infinite_3', 'infinite_4', 'infinite_5', 'infinite_6', 'infinite_boss'],
    allowedModifiers: ['narrow_corridor', 'fog_of_war', 'piece_drought', 'gravity_flux', 'obsidian_veins', 'mirror_world'],
    lootTable:        'infinite_loot',
    bossSlot:         { floor: 7, bossId: 'the_wither_storm' },
  },
};
...
var DUNGEON_LOOT_TABLES = {
  ...
  infinite_loot: {
    id: 'infinite_loot',
    drops: [
      { item: 'gold',            weight: 3, min: 5, max: 15 },
      { item: 'crystal',         weight: 3, min: 2, max: 6 },
      { item: 'diamond',         weight: 2, min: 1, max: 3 },
      { item: 'obsidian_shard',  weight: 2, min: 1, max: 2 },
      { item: 'xp',              weight: 4, min: 300, max: 800 },
    ],
  },
};
